...
class Payment extends StatefulWidget {
  ...
  PaymentState createState() => PaymentState(from_station: from_station, to_station: to_station, from_index: from_index, to_index: to_index);
}
...
class PaymentState extends State<Payment> {
  ...
  final String current_time = (DateTime(time.hour,time.minute)).toString();
  final String current_date = (DateTime(date.year,date.month,date.day)).toString();
...
//        return ((1+((to_index - from_index).abs())) * 5.0);
      return (((to_index - from_index).abs()) * 10.0);
  }
